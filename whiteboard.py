...
def solution(candy_amounts):
    most_candies = max(candy_amounts)
    extra_candy_needed = 0
    for kid in candy_amounts:
        extra_candy_needed += most_candies - kid
    return extra_candy_needed